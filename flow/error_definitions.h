...
ERROR( tenant_balancer_terminated, 1217, "Tenant balancer has been terminated" )
...
ERROR( movement_conflict, 2391, "The specified range overlaps with an existing movement")
...
ERROR( movement_aborted, 2398, "Movement has already been aborted")
